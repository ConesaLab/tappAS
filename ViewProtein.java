        ...
        for(AnnotationEntry entry : annotationList) {
            ...
            switch(dbcatid) { //entry.type) { //.toLowerCase()) {
                case PROTEIN:
                    ...
                    double wfulltxt = com.sun.javafx.tk.Toolkit.getToolkit().getFontLoader().computeStringWidth(fulltxt, gc.getFont());
                    gc.setFill(Color.WHITE);
                    gc.fillRect(pe.x, pe.y - 9, wfulltxt, 12);
                    gc.setFill(Color.MAROON);
                    gc.fillText(dspid, pe.x, pe.y);
                    gc.setFill(Color.GRAY);
                    double wtxt = com.sun.javafx.tk.Toolkit.getToolkit().getFontLoader().computeStringWidth(dspid, gc.getFont());
                    ...
                    width = com.sun.javafx.tk.Toolkit.getToolkit().getFontLoader().computeStringWidth(dspid, gc.getFont());
                        ...
                        default:
                            ...
                            if(args.prefs.alignment) {
                                if(dspExons) {
                                    ...
                                    displayExons(gc, xoffset, leftPadding, ymain, ppb, 
