 ...
 */
public class DlgFEAFilterFeatures extends DlgBase {
    ...
    public DlgFEAFilterFeatures(Project project, Window window) {
        super(project, window);
    }
    public Params showAndWait(Params dfltParams, HashMap<String, HashMap<String, Object>> hmFeatureIDs) {
        if(createDialog("FEAFilterFeatures.fxml", "FEA Enriched Features Display Filter", true, "Help_Dlg_FEA_FilterFeatures.html")) {
            setProjectName();
            params = dfltParams;
