 ...
 */
public class DlgUTRLAnalysis extends DlgBase {
    ...
    public DlgUTRLAnalysis(Project project, Window window) {
        super(project, window);
    }
    public Params showAndWait(Params dfltParams) {
        String fxml = project.data.isTimeCourseExpType()? "UTRLParams_TimeCourse.fxml" : "UTRLParams.fxml";
        //String fxml = "UTRLParams.fxml";
        if(createDialog(fxml, "UTR Lengthening Analysis Parameters", true, "Help_Dlg_UTRL.html")) {
            if(dfltParams == null)
    ...
    public static class Params extends DlgParams {
        ...
        private static final List<MethodData> lstMethods = Arrays.asList(
            ...
            new MethodData(Method.WILCOXON.name(), "Wilcoxon", DataApp.ExperimentType.Two_Group_Comparison),
        ...
        Utr dfltUtr = Utr.UTR3;
        private static final String UTR_PARAM = "utr";
        ...
        private Method dfltMethod = Method.WILCOXON;
        private double dfltSigValue = 0.05;
        private int dfltLengthValue = 100;
        ...
        public Params(Project project) {
            ...
            Method dfltMethod = expType.equals(DataApp.ExperimentType.Two_Group_Comparison)? DlgUTRLAnalysis.Params.Method.WILCOXON : DlgUTRLAnalysis.Params.Method.MASIGPRO;
            ...
            FilteringType dfltFilteringType = DlgUTRLAnalysis.Params.FilteringType.FOLD;
        ...
        public Params(HashMap<String, String> hmParams, Project project) {
            ...
            if(hmParams.isEmpty()) {
                ...
                this.utr = hmParams.containsKey(UTR_PARAM)? Utr.valueOf(hmParams.get(UTR_PARAM)) : dfltUtr;
