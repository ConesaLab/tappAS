 ...
 */
public class SubTabFEAClustersGraph extends SubTabBase {
    AnchorPane paneWeb;
    WebView webGraph;
    WebEngine engine;
    ...
    public SubTabFEAClustersGraph(Project project) {
        super(project);
    }
    @Override
    public boolean initialize(TabBase tabBase, SubTabInfo subTabInfo, HashMap<String, Object> args) {
        ...
        if(result) {
            ...
            if(!args.containsKey("id")) {
                if(subTabInfo.subTabId.length() > TabProjectDataViz.Panels.CLUSTERSFEA.name().length())
                    args.put("id", subTabInfo.subTabId.substring(TabProjectDataViz.Panels.CLUSTERSFEA.name().length()).trim());
            }
            if(args.containsKey("id")) {
                ...
                subTabInfo.title = "FEA Clusters Graph: '" + shortName + "'";
                subTabInfo.tooltip = "FEA enriched features clusters graph for '" + params.name + "'";
    ...
    private void showSubTab() {
        ...
        if(args.containsKey("html")) {
            ...
            String filepath = feaData.getFEAResultsClusterFilepath("graph", analysisId);
    ...
    private void exportImage() {
        ...
        app.export.exportImage("FEA Cluster", "tappAS_FEA_"+params.name+"_cluster.png", (Image)img);
    }
