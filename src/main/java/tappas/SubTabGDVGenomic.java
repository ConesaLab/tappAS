 ...
 */
public class SubTabGDVGenomic extends SubTabBase {
    Canvas canvas;
    ScrollPane spCanvas;
    TabGeneDataViz tabDataViz;

    private final ViewGenomic dvView;
    ...
    public SubTabGDVGenomic(Project project) {
        super(project);
        dvView = new ViewGenomic(project);
    }
    @Override
...
//        canvas.setScaleY(ratio);
        ...
        //Canvas scale lose quality
        WritableImage img = canvas.snapshot(new SnapshotParameters(), null);
        app.export.exportImage("Gene Genomic View", "tappAS_"+tabDataViz.gene+"_Gene_Genomic_View.png", (Image)img);
    }
