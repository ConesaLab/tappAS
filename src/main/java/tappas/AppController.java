...
public class AppController extends AppObject {
    ...
    public void loadInitialTabs() { 
        ...
        openingTabs = true; tabs = app.tabs; 
        tabs.openTab("tabAppInfo", null, null);
        loadingTabs = false; tabs.selectTab("tabAppInfo"); 
        fxdc.showStartPage(getProjectsHTML(), Tappas.APP_STRVER); 
        app.data.loadRscriptPath(); 
        app.runRscriptVersion(); 
        Path path = this.app.data.getTmpScriptFileFromResource("tappas_checkPackages.R"); 
        ...
        if (download) { 
            ...
            fxdc.showAppPaneInstalling(false); if (!installed) 
